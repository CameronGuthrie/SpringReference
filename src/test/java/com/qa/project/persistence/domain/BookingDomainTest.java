...
public class BookingDomainTest {
    ...
    void setUp() {
        ...
        booking = new BookingDomain(1L, agent, buyer, property, time);
    }
    ...
    void testAllArgumentConstructor() {
        ...
        assertEquals(agent, booking.getAgent());
    ...
    @Test
    void testGetAgent() {
        // Assert that the agent of the booking is correct
        assertEquals(agent, booking.getAgent());
    }
    ...
    @Test
    void testSetAgent() {
        // Set the agent on the booking object and assert that it is set correctly
		AgentDomain newAgent = mock(AgentDomain.class);
        booking.setAgent(newAgent);
        assertEquals(newAgent, booking.getAgent());
    }
